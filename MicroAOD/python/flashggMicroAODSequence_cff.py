...
#from flashgg.MicroAOD.flashggLeptonSelectors_cff import flashggSelectedMuons,flashggElectrons
...
#				       +electronMVAValueMapProducer*egmGsfElectronIDs*flashggElectrons*flashggElectrons
